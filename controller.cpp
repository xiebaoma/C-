...
void Controller::Start()//开始界面,实现开场动画
{
...
void Controller::Select()//选择界面，选择难度
{
    /*初始化界面选项*/
    SetColor(3);
    SetCursorPosition(13, 26);
    ...
    std::cout << "(Up and down key to select)";
    ...
    switch (key)//根据所选选项设置蛇的移动速度，speed值越小，速度越快,因为这里的speed是休眠时间
    {
    case 1:
        speed = 135;
        break;
...
void Controller::DrawGame()//绘制游戏界面
{
    ...
    std::cout << " D-pad movement";
    SetCursorPosition(33, 15);
    std::cout << " ESC key to pause";
}
...
int Controller::GameOver()//游戏结束界面
{
    ...
    std::cout << " ┃   Is there another round?                ┃";
    Sleep(30);
    ...
    std::cout << " ┃    Well, okay        No, thank you       ┃";
    Sleep(30);
